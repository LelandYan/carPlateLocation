...
class LicenseLocator:
    def __init__(self, fileName=None, result=None):
        ...
        self.CARPLATE_WEIGHTS_PATH = "mask_rcnn_carplate_0030.h5"
    ...
    def fit(self):
        ...
        self.image = modelib.load_image_gt(self.fileName, self.config)
        # 模型预测功能
...
if __name__ == '__main__':
    ...
    model = LicenseLocator("川AZ408T.jpg", "resultCut.jpg")
    model.fit()
    model.getRectImage()
